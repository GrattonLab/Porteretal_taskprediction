...
elseif strcmp(atlas,'PowerExpanded')
    ...
    atlas_params.distmat = '/Quest_Backup/Atlases/PowerSpheres_expanded/298/power_expanded_distmat.mat';
    atlas_params.allroi_file = '/Quest_Backup/Atlases/PowerSpheres_expanded/298/BigBrain298_711-2b_allROIs.4dfp.img';    
...
elseif strcmp(atlas,'Spheres300')
    ...
    atlas_params.atlas_file = [atlasdir 'BigBrain300/BigBrain300_roilist_newnames_sorted.txt']; %'BigBrain300_roilist';
    %atlas_params.roi_file = [homedir 'task_fc_scrubbed_' atlas '/' atlas_params.atlas_file '_RMAT_fast.roi'];
...
elseif strcmp(atlas,'Parcels')
    ...
    atlas_params.atlas_file = 'parcel_centers/Parcels_711-2b_withcoords_roilist';
    atlas_params.roi_file = [atlasdir 'parcel_centers/parcel_center_7112b.roi'];
    atlas_params.dmat = [atlasdir 'Parcels333_Euclidean_dmat.mat'];
...
elseif strcmp(atlas,'Parcel_Centers')
    atlas_params.atlas = atlas;
