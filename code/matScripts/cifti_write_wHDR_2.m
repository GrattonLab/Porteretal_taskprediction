...
elseif strcmp(ciftitemplatefile(end-(length(extension)-1):end),extension)
    system(['wb_command -cifti-convert -to-gifti-ext ' ciftitemplatefile ' WritingTemp.func.gii'])
...
switch filetype
    ...
    case 'dconn'
        ...
        system(['wb_command -cifti-convert -from-gifti-ext ' outnamestem '.func.gii ' outnamestem '.dconn.nii'])
     ...
     case 'pconn'
        ...
        system(['wb_command -cifti-convert -from-gifti-ext ' outnamestem '.func.gii ' outnamestem '.pconn.nii'])
    ...
    case 'dtseries'
        ...
        system(['wb_command -cifti-convert -from-gifti-ext ' outnamestem '.func.gii ' outnamestem '.dtseries.nii'])
