...
dataF=['/Users/aporter1350/Desktop/Porteretal_taskprediction/output/results/Ridge/ALL_Binary/fw/groupwise_fw.csv']; %'/' subs{j} '.csv'];
data=load(dataF);
...
for i=1:length(task);
    %for j=1:length(folds);
        dataF=['/Users/aporter1350/Desktop/Porteretal_taskprediction/output/results/Ridge/single_task/fw/' task{i} 'groupwise_fw.csv']; %'/' subs{j} '.csv'];
        data=load(dataF);
        dir=['/Users/aporter1350/Desktop/Porteretal_taskprediction/output/results/Ridge/single_task/fw/'];
